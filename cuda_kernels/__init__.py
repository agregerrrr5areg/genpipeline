...
class SparseConv3d(nn.Module):
    ...
    def forward(self, x: torch.Tensor, mask: torch.Tensor = None) -> torch.Tensor:
        ...
        return ext.sparse_conv3d(x.contiguous(), self.weight.contiguous(), bias.contiguous(), mask.contiguous())

__all__ = ["gpu_voxelize", "gpu_marching_cubes", "fused_reparameterize", "SparseConv3d", "build_occupancy_mask"]
