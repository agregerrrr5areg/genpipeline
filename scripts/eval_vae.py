...
try:
    import genpipeline.fem.data_pipeline
    sys.modules["fem_data_pipeline"] = genpipeline.fem.data_pipeline
except ImportError:
    pass
...
def main():
    ...
    parser.add_argument("--fem-data",    default="./genpipeline/fem/data")
