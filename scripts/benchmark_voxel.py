...
import trimesh
import torch
from genpipeline.fem.data_pipeline import VoxelGrid
import logging
...
def benchmark_voxelizer(stl_path, resolutions=[32, 64, 128, 256]):
    ...
    for res in resolutions:
        ...
        cuda_time = 0
        try:
            from genpipeline.cuda_kernels import gpu_voxelize
...
if __name__ == "__main__":
    stl_file = "genpipeline/fem/data/tape_v42_f1073_32x6x10_b2dae516_mesh.stl"
