    ...
    with st.spinner("Running FreeCAD FEM on best design..."):
        try:
            ...
            if fem:
                ...
                st.toast(f"Validated: stress_max = {fem.stress_max:.1f} MPa", icon="✅")
            else:
...
with left_col:
    ...
    for v in variants:
        ...
        is_best = (app_state.best and app_state.best.fem and
                   abs(v.get("stress_max", 0) - app_state.best.fem.stress_max) < 1)
